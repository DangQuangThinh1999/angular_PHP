...
$SANPHAM = [];
$sql = "SELECT MASP, TENSP, GIABAN, SOTRANG, NGONNGU, KICHTHUOC, TRONGLUONG, MOTA, ANHBIA, NGAYCAPNHAT, SOLUONGTON, loai.TENLOAI, nhaxuatban.TENXB FROM sanpham, loai,nhaxuatban WHERE sanpham.mal = loai.mal and nhaxuatban.MANXB=sanpham.MANXB and loai.TENLOAI='$TENLOAI'";
